	...
	def sendMessage():
		while True:
			...
			for letter in encrypt:
				if letter in latin:
					position = latin.find(letter)
					newposition = position + key
					if letter in latin:
						encrypted = encrypted + latin[newposition]
					else:
						continue
				elif letter in kyrylica:
					position = kyrylica.find(letter)
					newposition = position + key
					if letter in kyrylica:
						encrypted = encrypted + kyrylica[newposition]
					else:
						continue

				elif letter in numbers:
					position = numbers.find(letter)
					newposition = position + key
					if letter in numbers:
						encrypted = encrypted + numbers[newposition]
					else:
						continue
				else:
